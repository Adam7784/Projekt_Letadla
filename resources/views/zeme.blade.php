    ...
    <br>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-4">
            ...
            <div class="card w-full bg-base-100 shadow-xl">
                    <figure>
                        <img src="{{ asset('obrazky/' . $zeme->image) }}" alt="{{ $zeme->zeme_nazev }}" class="w-64 h-64 object-cover">
                    </figure>
                    <div class="card-body">
                        <h2 class="card-title">
                            {{ $zeme->zeme_nazev }}
                        ...
                        <p>ID: {{ $zeme->zeme_id }}</p>
                                ...
                                <div class="card-actions justify-end">
                                    ...
                                    <button class="btn btn-outline btn-error" data-id="{{ $zeme->zeme_id }}" onclick="setFormAction('{{ $zeme->zeme_id }}')">Smazat</button>
                                </div>
                    </div>
                </div>
